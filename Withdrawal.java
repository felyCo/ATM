        ...
        public void execute()
        {
            ...
            do
            {
                ...
                if ( amount != CANCELED )
                {
                    ...
                    // check whether the cash dispenser has enough money in the account
                    ...
                    if ( cashDispenser.isSufficientCashAvailable( amount ))
                    {
                        ...
                        screen.displayMessageLine( "\nYour cash has been " + "dispensed.Please take your now.");  
                    } // end if
        ...
        private int displayMenuOfAmounts()
        {
            ...
            while ( userChoice == 0 )
            {
                ...
                switch ( input )
                {
                    ...
                    case 3: // corresponding amount from amount array
                    case 4:
                    case 5:
